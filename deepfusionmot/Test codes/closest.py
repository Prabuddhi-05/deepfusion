...
class RealTimeFusionNode(Node):  # ROS2 Node
    def __init__(self, cfg):
        ...
        # ---------------------------------------------------------
        # Approximate-time Synchronization for /camera/image_raw + /lidar/points
        # ---------------------------------------------------------
        image_sub = Subscriber(self, Image, '/camera/image_raw')
        lidar_sub = Subscriber(self, PointCloud2, '/lidar/points')

        # Using a larger slop for more flexible synchronization at startup
        ...
        self.get_logger().info("RealTimeFusionNode initialized, using **ApproximateTimeSynchronizer** for image and point cloud topics.")

    # ============================================================
    #  Synchronized Sensor Callback (Approximate Timestamps)
    # ============================================================
    ...
    # ============================================================
    def get_nearest_detection_data(self, ts_key, max_delta=0.2):  # Increased max_delta
        def to_sec(key):
    ...
    def run_fusion_and_update(self, tracker, dets_2d, dets_3d, category_name):
        ...
        # Placeholder for actual fusion/tracking update
    ...
    def project_3d_box(self, box3d_tmp):
        # Placeholder: project 3D box to 2D image plane
